  ...
  return (
    ...
    >
        ...
        <div className="w-24 h-24 sm:w-full sm:h-40 shrink-0 relative z-10">
          ...
          {isOutOfStock && (
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center rounded-xl">
              <span className="bg-white/90 text-red-600 font-black text-[10px] uppercase tracking-widest px-2 py-1 rounded">Esgotado</span>
            </div>
          )}
        </div>
      )}

      {!product.imageUrl && isOutOfStock && (
      ...
      <div className="z-10 flex-1 flex flex-col justify-between">
        <div className={!product.imageUrl && isOutOfStock ? 'pt-6' : ''}>
